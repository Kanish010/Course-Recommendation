...
# List of interest terms for Vancouver campus from the course full names
vancouver_interest_terms = [
    ...
    "Applied Biology", "Applied Science", "Applied Science Professional Program Platform",
    "Aquaculture", "Architecture", "Archival Studies", "Art History",
    ...
    "Audiology and Speech Sciences", "Biochemistry", "Biochemistry and Forensic Science",
    ...
    "Geographical Sciences", "Geography", "Geomatics for Environmental Management",
    "German", "Germanic Studies", "Global Resource Systems", "Greek",
    ...
    "Journalism", "Kinesiology", "Korean", "Land & Food Systems", "Land and Water Systems",
    "Landscape Architecture", "Language and Literacy Education", "Latin",
    ...
    "Near Eastern Studies", "Nepali", "Neuroscience", "Neuroscience Undergraduate",
    "Neurosurgery", "Nordic Studies", "Nursing", "Obstetrics and Gynaecology",
    ...
    "Persian", "Pharmaceutical Sciences", "Pharmacology and Therapeutics",
    "Pharmacy", "Philosophy", "Physical Therapy", "Physics",
    ...
    "Soil Science", "South Asian Languages", "Southeast Asian Languages",
    "Spanish", "Statistics", "Study of Religion", "Surgery",
    "Sustainable Process Engineering", "Swahili", "Swedish", "Teacher Librarianship",
    "Theatre", "Theatre And Film", "Tibetan Languages", "Ukrainian",
...
# Load Vancouver courses data
vancouver_courses = pd.read_csv('CourseData/ubc_vancouver_courses.csv')

# Create fine-tuning data for Vancouver
vancouver_fine_tuning_data = create_fine_tuning_data(vancouver_courses, vancouver_interest_terms)

# Save as JSONL
save_jsonl(vancouver_fine_tuning_data, 'CsvToJsonl/ubc_vancouver_courses.jsonl')

print("Vancouver fine-tuning data creation completed!")